...
python scripts/inference.py \
    ...
    --model_dir_medium_noise="models/subj2subj3subj4subj5Andsubj6Trained/MyDnCNN_medium_noise" \
...
python scripts/inference.py \
    ...
    --model_dir_medium_noise="models/subj1subj3subj4subj5Andsubj6Trained/MyDnCNN_medium_noise" \
...
python scripts/inference.py \
    ...
    --result_dir="results/AllButsubj3Trainedsubj3Tested_results" \
    ...
    --model_dir_medium_noise="models/subj1subj2subj4subj5Andsubj6Trained/MyDnCNN_medium_noise" \
    --model_dir_high_noise="models/subj1subj2subj4subj5Andsubj6Trained/MyDnCNN_high_noise"
...
python scripts/inference.py \
    ...
    --model_dir_medium_noise="models/subj1subj2subj3subj5Andsubj6Trained/MyDnCNN_medium_noise" \
...
python scripts/inference.py \
    ...
    --model_dir_medium_noise="models/subj1subj2subj3subj4Andsubj6Trained/MyDnCNN_medium_noise" \
...
python scripts/inference.py \
    ...
    --model_dir_medium_noise="models/subj1subj2subj3subj4Andsubj5Trained/MyDnCNN_medium_noise" \
