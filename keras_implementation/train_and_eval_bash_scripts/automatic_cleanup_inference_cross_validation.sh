...
#    --model_dir_cleanup="residual_std_models/AllButsubj1Trained/MyDnCNN_cleanup" \
...
#    --model_dir_cleanup="psnr_models/AllButsubj1Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
...
#    --model_dir_cleanup="residual_std_models/AllButsubj2Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
...
#    --model_dir_cleanup="psnr_models/AllButsubj2Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
# Run inference for subj2 (PSNR estimated)
printf "Calling test.py for model trained on all but subj2...\n"
python scripts/inference.py \
...
#    --model_dir_cleanup="residual_std_models/AllButsubj3Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
...
#    --model_dir_cleanup="psnr_models/AllButsubj3Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
# Run inference for subj3 (PSNR estimated)
printf "Calling test.py for model trained on all but subj3...\n"
python scripts/inference.py \
...
#    --model_dir_cleanup="residual_std_models/AllButsubj4Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
...
#    --model_dir_cleanup="psnr_models/AllButsubj4Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
# Run inference for subj4 (PSNR estimated)
printf "Calling test.py for model trained on all but subj4...\n"
python scripts/inference.py \
...
#    --model_dir_cleanup="residual_std_models/AllButsubj5Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
...
#    --model_dir_cleanup="psnr_models/AllButsubj5Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
# Run inference for subj5 (PSNR estimated)
printf "Calling test.py for model trained on all but subj5...\n"
python scripts/inference.py \
...
#    --model_dir_cleanup="residual_std_models/AllButsubj6Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
...
#    --model_dir_cleanup="psnr_models/AllButsubj6Trained/MyDnCNN_cleanup" \
#    --skip_patch_denoise=1 --cleanup_denoise=1
# Run inference for subj6 (PSNR estimated)
printf "Calling test.py for model trained on all but subj6...\n"
python scripts/inference.py \
