...
#    --train_data="data/subj5/train" --train_data="data/subj6/train" \
#    --val_data="data/subj3/train" --result_dir="psnr_models/AllButsubj2Trained" --is_3d=True
#############
...
#    --train_data="data/subj5/train" --train_data="data/subj6/train" \
#    --val_data="data/subj4/train" --result_dir="psnr_models/AllButsubj3Trained" --is_3d=True
#############
...
#    --train_data="data/subj5/train" --train_data="data/subj6/train" \
#    --val_data="data/subj5/train" --result_dir="psnr_models/AllButsubj4Trained" --is_3d=True
#############
...
#    --val_data="data/subj4/train" --result_dir="psnr_models/AllButsubj5Trained" --is_3d=True
#############
...
#    --val_data="data/subj4/train" --result_dir="psnr_models/AllButsubj6Trained" --is_3d=True
#############
