...
#    --model_dir_all_noise="psnr_models/${TRAINED_DIR}Trained/MyDnCNN_all_noise" \
#    --model_dir_low_noise="psnr_models/${TRAINED_DIR}Trained/MyDnCNN_low_noise" \
#    --model_dir_medium_noise="psnr_models/${TRAINED_DIR}Trained/MyDnCNN_medium_noise" \
#    --model_dir_high_noise="psnr_models/${TRAINED_DIR}Trained/MyDnCNN_high_noise"
##############################################################################################
